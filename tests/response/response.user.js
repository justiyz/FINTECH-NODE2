...
export const zeehVerifyBvnTestResponse = (user, bvn) => {
  const data = {
    ...
    data: {
      ...
      firstName: user.first_name,
      lastName: user.last_name,
      middleName: user.middle_name !== null ? user.middle_name : '',
      gender: user.gender,
      dateOfBirth: user.date_of_birth,
      phoneNumber1: user.phone_number,
      photo: '/9j/4AAQSkZJRgABAgAAAQABAAD/2wBDAAgGBgcGBQgHBwcJCQgKDBQNDAsLDBkSEw8UHRofHh0a\n' +
          'HBwgJC4nICIsIxwcKDcpLDAxNDQ0Hyc5PTgyPC4zNDL/2wBDAQkJCQwLDBgNDRgyIRwhMjIyMjIy\n' +
          'MjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjL/wAARCAHSAV4DASIA\n' +
          'AhEBAxEB/8QAHwAAAQUBAQEBAQEAAAAAAAAAAAECAwQFBgcICQoL/8QAtRAAAgEDAwIEAwUFBAQA\n' +
      ...
      lgaOfResidence: 'Badagry',
      maritalStatus: 'Married',
      nameOnCard: '242 c compound badagry',
      nationality: 'Nigeria',
      nin: '',
      phoneNumber2: '',
      registrationDate: '',
      residentialAddress: '242 c compound badaGRY ',
...
export const zeehVerifyBvnTestResponseOld = (user, bvn) => {
  const data = {
    status: 'success',
    code: 0,
    data: {
