export default {
  ...
  WHERE (TRIM(CONCAT(first_name, ' ', middle_name, ' ', last_name)) ILIKE TRIM($1) OR $1 IS NULL) AND (personal_loans.status = $2 OR $2 IS NULL) 
  ...
  fetchRepaidLoans: `
      ...
      WHERE personal_loan_payment_schedules.status = 'paid' AND (TRIM(CONCAT(first_name, ' ', middle_name, ' ', last_name)) ILIKE TRIM($1) OR $1 IS NULL)  
