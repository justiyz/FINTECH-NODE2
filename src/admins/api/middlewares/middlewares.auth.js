...
export const compareAdminPassword = async(req, res, next) => {
  try {
    ...
    adminActivityTracking(req.admin.admin_id, 9, 'fail', descriptions.login_request_failed(`${req.admin.first_name} ${req.admin.last_name}`));
...
export const adminPermissions = async(req, res, next) => {
  try {
    ...
    adminActivityTracking(req.admin.admin_id, 10, 'fail', descriptions.login_approved_failed(`${req.admin.first_name} ${req.admin.last_name}`));
