...
export const create_manual_loan = (adminName, userName) => `Admin ${adminName}, creates a manual loan for ${userName} successfully`;
export const create_manual_loan_failed = (adminName, userName) => `Admin ${adminName}, creating a manual loan for ${userName} failed`;
export const create_pre_approved_loan = (adminName, userName) => `Admin ${adminName}, creates pre-approved loan ${userName} successfully`;
export const manual_loan_repayment = (adminName, userName) => `Admin ${adminName}, repaid ${userName}'s loan successfully`;
export const manual_loan_repayment_failed = (adminName, userName) => `Admin ${adminName}, repaying ${userName}'s loan failed`;
export const reschedule_manual_loan = (adminName, userName) => `Admin ${adminName}, reschedules ${userName}'s loan successfully`;
export const reschedule_manual_loan_failed = (adminName, userName) => `Admin ${adminName}, rescheduling ${userName}'s loan failed`;
export const update_merchant_account_info = (adminName, businessName) => `Admin ${adminName}, updates ${businessName}'s account info`;
export const update_merchant_account_info_failed= (adminName, businessName) => `Admin ${adminName}, updating ${businessName}'s account info failed`;
export const update_merchant_user_details= (adminName, businessName) => `Admin ${adminName}, updates ${businessName}'s details successfully`;
