...
export const set_user_reward_points_to_zero = (name, type) => `${name} sets reward point for ${type} to zero`;
export const set_users_reward_points_to_zero = (name) => `${name} sets all users reward points to zero`;
