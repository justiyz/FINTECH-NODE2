const {
  ...
  SEEDFI_TEST_FIREBASE_DYNAMIC_LINK_PRIVATE_KEY,
  SEEDFI_TEST_DOMAIN_URL_PREFIX,
  SEEDFI_TEST_ANDROID_PACKAGE_NAME,
  SEEDFI_TEST_IOS_BUNDLE_ID
} = process.env;
...
export default {
  ...
  SEEDFI_FIREBASE_DYNAMIC_LINK_KEY: SEEDFI_TEST_FIREBASE_DYNAMIC_LINK_PRIVATE_KEY,
  SEEDFI_DOMAIN_URL_PREFIX: SEEDFI_TEST_DOMAIN_URL_PREFIX,
  SEEDFI_ANDROID_PACKAGE_NAME: SEEDFI_TEST_ANDROID_PACKAGE_NAME,
  SEEDFI_IOS_BUNDLE_ID: SEEDFI_TEST_IOS_BUNDLE_ID
};
