const {
  ...
  SEEDFI_TEST_CLOUDINARY_UPLOAD_URI,
  SEEDFI_TEST_CLOUDINARY_CLOUD_NAME,
  SEEDFI_TEST_CLOUDINARY_API_KEY,
  SEEDFI_TEST_CLOUDINARY_API_SECRET,
  SEEDFI_TEST_SHOP_PERCENTAGE,
  SEEDFI_TEST_UNDERWRITING_APP_ACCESS_TOKEN,
  SEEDFI_TEST_RECOVA_BEARER_TOKEN,
  SEEDFI_TEST_LOAN_DISBURSEMENT_ACCOUNT_NUMBER,
  SEEDFI_TEST_LOAN_DISBURSEMENT_ACCOUNT_NAME,
  SEEDFI_TEST_LOAN_DISBURSEMENT_BANK_CODE,
  SEEDFI_TEST_LOAN_DISBURSEMENT_BANK_NAME,
  SEEDFI_TEST_RECOVA_BASE_URL,
  SEEDFI_TEST_RECOVA_INSTITUTION_CODE,
  SEEDFI_TEST_MERCHANT_ADMIN_WEB_BASE_URL,
  SEEDFI_TEST_API_VERSION,
  SEEDFI_TEST_DOJAH_SIGNATURE,
  SEEDFI_TEST_MONO_REDIRECT_URL,
} = process.env;
...
export default {
  ...
  SEEDFI_CLOUDINARY_UPLOAD_URI: SEEDFI_TEST_CLOUDINARY_UPLOAD_URI,
  SEEDFI_CLOUDINARY_CLOUD_NAME: SEEDFI_TEST_CLOUDINARY_CLOUD_NAME,
  SEEDFI_CLOUDINARY_API_KEY: SEEDFI_TEST_CLOUDINARY_API_KEY,
  SEEDFI_CLOUDINARY_API_SECRET: SEEDFI_TEST_CLOUDINARY_API_SECRET,
  SEEDFI_SHOP_PERCENTAGE: SEEDFI_TEST_SHOP_PERCENTAGE,
  SEEDFI_UNDERWRITING_APP_ACCESS_TOKEN: SEEDFI_TEST_UNDERWRITING_APP_ACCESS_TOKEN,
  SEEDFI_RECOVA_BEARER_TOKEN: SEEDFI_TEST_RECOVA_BEARER_TOKEN,
  SEEDFI_LOAN_DISBURSEMENT_ACCOUNT_NUMBER: SEEDFI_TEST_LOAN_DISBURSEMENT_ACCOUNT_NUMBER,
  SEEDFI_LOAN_DISBURSEMENT_ACCOUNT_NAME: SEEDFI_TEST_LOAN_DISBURSEMENT_ACCOUNT_NAME,
  SEEDFI_LOAN_DISBURSEMENT_BANK_CODE: SEEDFI_TEST_LOAN_DISBURSEMENT_BANK_CODE,
  SEEDFI_LOAN_DISBURSEMENT_BANK_NAME: SEEDFI_TEST_LOAN_DISBURSEMENT_BANK_NAME,
  SEEDFI_RECOVA_BASE_URL: SEEDFI_TEST_RECOVA_BASE_URL,
  SEEDFI_RECOVA_INSTITUTION_CODE: SEEDFI_TEST_RECOVA_INSTITUTION_CODE,
  SEEDFI_MERCHANT_ADMIN_WEB_BASE_URL: SEEDFI_TEST_MERCHANT_ADMIN_WEB_BASE_URL,
  SEEDFI_API_VERSION: SEEDFI_TEST_API_VERSION,
  SEEDFI_DOJAH_SIGNATURE: SEEDFI_TEST_DOJAH_SIGNATURE,
  SEEDFI_MONO_REDIRECT_URL: SEEDFI_TEST_MONO_REDIRECT_URL,
};
