const {
  ...
  SEEDFI_PROD_FIREBASE_DYNAMIC_LINK_PRIVATE_KEY,
  SEEDFI_PROD_DOMAIN_URL_PREFIX,
  SEEDFI_PROD_ANDROID_PACKAGE_NAME,
  SEEDFI_PROD_IOS_BUNDLE_ID
} = process.env;
...
export default {
  ...
  SEEDFI_FIREBASE_DYNAMIC_LINK_KEY: SEEDFI_PROD_FIREBASE_DYNAMIC_LINK_PRIVATE_KEY,
  SEEDFI_DOMAIN_URL_PREFIX: SEEDFI_PROD_DOMAIN_URL_PREFIX,
  SEEDFI_ANDROID_PACKAGE_NAME: SEEDFI_PROD_ANDROID_PACKAGE_NAME,
  SEEDFI_IOS_BUNDLE_ID: SEEDFI_PROD_IOS_BUNDLE_ID
};
