...
export const ticketPDFTemplate = (ticket_qr_code, purchase_date, ticket_category, user, ticket_record) => `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8" />
   ...
   <body style="padding: 50px; font-family: 'Roboto', sans-serif">
      ...
      <div style="margin-top: 30px">
         ...
         <div style="margin-top: 30px"> <span style="font-weight: bold">Ticket Information</span> </div>
         <table style="margin-top: 10px;">
            <tr>
               <td><img class="barcode" height="137" width="137" src="${ticket_qr_code}" alt="" /> </td>
               <td>
                  <div> <span>Ticket Type:</span> <span style="font-weight: bold; text-transform: capitalize">${ticket_category.ticket_category_type}</span> </div>
                  <div style="margin-top: 10px"> <span>Venue:</span> <span style="font-weight: bold">${ticket_record.event_location}</span> </div>
                  <div style="margin-top: 10px"> <span>Date:</span> <span style="font-weight: bold">${ticket_record.event_date}</span> </div>
                  <div style="margin-top: 10px"> <span>Time:</span> <span style="font-weight: bold">${ticket_record.event_time}</span> </div>
               </td>
            </tr>
         </table>
      </div>
