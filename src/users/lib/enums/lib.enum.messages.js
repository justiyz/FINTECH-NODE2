...
export const MERCHANT_ACCOUNT_STATUS = status => `User account is ${status}`;
...
export const BVN_INFORMATION_UNAVAILABLE = 'We could not verify customer information';
...
export const UNDERWRITING_SERVICE_FAILURE = 'Loan application unsuccessful, please try again later';
export const REQUESTED_NUMBER_OF_TICKETS_NOT_AVAILABLE = 'Requested number of tickets not available';
...
export const MERCHANT_ADMIN_LOGIN_SUCCESSFULLY = 'Merchant Admin logged in successfully';
export const MERCHANT_ADMIN_PASSWORD_UPDATE_FAILED = 'Failed to update admin password';
export const MERCHANT_ADMIN_PASSWORD_UPDATE_SUCCESSFUL = 'Updated merchant admin password successfully';
...
export const MERCHANT_ACCOUNT_DEACTIVATED = 'Account is deactivated, kindly contact support';
...
export const FAILED_TO_CREATE_USER_TICKET = 'failed to create user ticket successfully';
export const CREATE_USER_TICKET_SUCCESSFULLY = 'created user ticket successfully';
...
export const MERCHANT_ONBOARDED_SUCCESSFULLY = 'Merchant onboarded successfully';
export const MERCHANT_ADMIN_CREATED_SUCCESSFULLY = 'Merchant admin created successfully';
...
export const COMMERCIAL_BANK_REQUIRED = `Change your bank account to a commercial bank account to proceed`;
