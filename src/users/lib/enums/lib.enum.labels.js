...
export const CHECK_OTP_VERIFICATION_REQUEST_COUNT_MIDDLEWARE = 'AuthMiddleware::checkOtpVerificationRequestCount';
...
export const PROCESS_CLUSTER_LOAN_TRANSFER_PAYMENTS_MIDDLEWARE = 'PaymentMiddleware::processClusterLoanTransferPayments';
...
export const UPDATE_BANK_INFORMATION = 'UserController:updateBankRecord';
export const DELETE_BANK_CONTROLLER = 'UserController:deleteBankRecord';
export const CREATE_BANK_CONTROLLER = 'UserController:createBankRecord';
...
export const CHECK_AVAILABLE_TICKET_UNITS_MESSAGE = 'TicketMiddleware::checkAvailableNumberOfTicketsBeforePurchase';
export const CHECK_AVAILABLE_TICKET_UNITS = 'TicketMiddleware::checkAvailableNumberOfTicketsBeforePurchase';
export const VALIDATE_RENEGOTIATION_AMOUNT_MIDDLEWARE = 'LoanMiddleware::validateRenegotiationAmount';
export const CHECK_AVAILABLE_TICKETS_MIDDLEWARE = 'TicketMiddleware::checkAvailableTickets';
...
export const CHECK_IF_MEMBER_CLUSTER_LOAN_APPLICATION_STATUS_IS_STILL_PENDING_MIDDLEWARE = 'ClusterMiddleware::checkIfMemberClusterLoanApplicationStatusIsStillPending';
export const SORT_CLUSTER_LOAN_AMOUNT_MIDDLEWARE = 'ClusterMiddleware::sortClusterLoanAmount';
...
export const TICKET_REQUESTED_HIGHER_THAN_AVAILABLE_UNITS = 'TicketMiddleware::checkAvailabeTicketUnitsAvailable';
...
export const TICKET_PURCHASE_SHOP_CONTROLLER = 'ShopController::createTicketSubscription';
export const CHECK_USER_TICKET_LOAN_ELIGIBILITY_CONTROLLER = 'LoanController::checkUserTicketLoanEligibility';
export const PROCESS_LOAN_RENEGOTIATION_CONTROLLER = 'LoanController::processLoanRenegotiation';
export const PROCESS_CLUSTER_LOAN_RENEGOTIATION_CONTROLLER = 'ClusterController::processClusterLoanRenegotiation';
export const FETCH_CLUSTER_MEMBER_LOAN_DETAILS_CONTROLLER = 'ClusterController::fetchClusterMemberLoanDetails';
export const CLUSTER_MEMBER_LOAN_DECISION_CONTROLLER = 'ClusterController::clusterMemberLoanDecision';
...
export const FETCH_CLUSTER_LOAN_PAYMENT_DETAILS_CONTROLLER = 'LoanController::fetchClusterLoanPaymentDetails';
export const INITIATE_MANUAL_LOAN_REPAYMENT_CONTROLLER = 'LoanController::initiateManualLoanRepayment';
export const INITIATE_MANUAL_CLUSTER_LOAN_REPAYMENT_CONTROLLER = 'ClusterController::initiateManualClusterLoanRepayment';
export const INITIATE_MANUAL_CARD_OR_BANK_LOAN_REPAYMENT_CONTROLLER = 'LoanController::initiateManualCardOrBankLoanRepayment';
export const INITIATE_MANUAL_CARD_OR_BANK_CLUSTER_LOAN_REPAYMENT_CONTROLLER = 'ClusterController::initiateManualCardOrBankClusterLoanRepayment';
export const FETCH_USER_CURRENT_LOANS_CONTROLLER = 'LoanController::fetchUserCurrentLoans';
export const INDIVIDUAL_LOAN_RESCHEDULING_DURATIONS_CONTROLLER = 'LoanController::individualLoanReschedulingDurations';
...
export const INITIATE_CLUSTER_LOAN_DISBURSEMENT_CONTROLLER = 'ClusterController::initiateClusterLoanDisbursement';
...
export const CHECK_IF_BELONGS_TO_TYPE_OF_CLUSTER_MIDDLEWARE = 'ClusterMiddleware::checkIfUserBelongsToTypeOfCluster';
...
export const CHECK_IF_CLUSTER_MEMBER_IS_ADMIN_MIDDLEWARE = 'ClusterMiddleware::checkIfClusterMemberIsAdmin';
export const CHECK_IF_CLUSTER_HAS_ACTIVE_LOAN_MIDDLEWARE = 'ClusterMiddleware::checkIfClusterHasActiveLoan';
...
export const CHECK_CLUSTER_ADMIN_CLUSTER_LOAN_ELIGIBILITY_CONTROLLER = 'ClusterController::checkClusterAdminClusterLoanEligibility';
...
export const UPLOAD_IMAGE_MIDDLEWARE = 'AdminUserMiddleware::uploadImage';
...
export const FAILED_TO_FETCH_USER_BVN = 'AdminUserController::fetchBVNbyUserIid';
...
export const APPROVE_CLUSTER_MEMBER_LOAN_APPLICATION_CONTROLLER = 'AdminLoanController::approveClusterMemberLoanApplication';
export const DECLINE_LOAN_APPLICATION_CONTROLLER = 'AdminLoanController::declineLoanApplication';
export const DECLINE_CLUSTER_MEMBER_LOAN_APPLICATION_CONTROLLER = 'AdminLoanController::declineClusterMemberLoanApplication';
...
export const FETCH_DETAILS_OF_A_CLUSTER_MEMBER_CONTROLLER = 'AdminLoanController::fetchSingleMemberClusterLoanDetails';
export const REPAID_LOANS_CONTROLLER = 'AdminLoanController::fetchRepaidLoans';
export const FETCH_ENV_VALUES_CONTROLLER = 'AdminSettingsController::fetchEnvValues';
export const FETCH_REWARD_POINT_DETAILS_CONTROLLER = 'AdminSettingsController::fetchRewardPointDetails';
export const UPDATE_CLUSTER_RELATED_REWARDS_CONTROLLER = 'AdminSettingsController::updateClusterRelatedRewards';
export const UPDATE_GENERAL_REWARD_RANGES_CONTROLLER = 'AdminSettingsController::updateGeneralRewardRanges';
export const UPDATE_GENERAL_REWARDS_CONTROLLER = 'AdminSettingsController::updateGeneralRewards';
...
export const CLUSTER_MEMBER_BULK_INVITE_MIDDLEWARE = 'AdminClusterMiddleware::clusterMemberBulkInvite';
...
export const FETCH_PROMO_DETAILS_CONTROLLER = 'AdminSettingsController::fetchSinglePromo';
export const EDIT_PROMO_DETAILS_CONTROLLER = 'AdminSettingsController::editPromoDetails';
...
export const CHECK_GENERAL_REWARD_BEFORE_EDITING_MIDDLEWARE = 'AdminSettingsMiddleware::checkGeneralRewardBeforeEditing';
...
export const UPDATE_EVENT_SUCCESSFUL = 'ShopController::updateEventRecord';
export const EDIT_EVENT_RECORD = 'ShopController::updateEventRecord2';
export const TABLE_INTEGRITY_CONSTRAINT = 'ShopController::updateEventRecord2::Error';
...
export const EVENT_NOT_FOUND = 'ShopController::updateEventRecord';
export const EVENT_TICKET_NOT_FOUND = 'ShopController::updateEventTicketCategory';
export const EVENT_RECORD_NOT_FOUND = 'ShopController::createEventRecord';
export const EDIT_EVENT_TICKET_CATEGORY = 'ShopController::editEventTicketCategory';
